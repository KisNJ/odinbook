...
const Header = ({ back_to_main }: { back_to_main?: boolean }) => {
  ...
  return (
    <header className="bg-sky-700 text-gray-100 flex justify-between items-center md:px-20 md:py-5 w-full py-2 px-2 flex-wrap">
      <Link href="/mainpage">
        <button>
      ...
      <div className="flex gap-5 items-center relative lg:basis-[30rem] xl:basis-[40rem]">
        <div className="dropdown min-w-full sm:block hidden">
          <label tabIndex={0}>
      ...
      <div className="flex md:gap-10 items-center">
        ...
        <div className="group relative">
          <button className="text-xl focus:underline hover:underline underline-offset-3 ml-3">
            Profile
          </button>
          <div className="absolute z-10 scale-0 group-focus-within:scale-100 bg-gray-100 text-sky-700 p-5 rounded-lg shadow-md md:right-[-45px] right-[0px] flex flex-col gap-2 truncate transition-transform mt-3">
            <button
      ...
      <div className="dropdown min-w-full block sm:hidden">
        <label tabIndex={0}>
          <div className="flex gap-3 items-center">
            <div className="hidden md:block">
              <BiSearch size={22} />
